                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example3c"><i class="bi bi-telephone-fill"></i> Your Phone Number</label>
                        <input type="phonenumber" id="form3Example3c" class="form-control form-control-lg py-3" name="phonenumber" autocomplete="off" placeholder="enter your phonenumber" style="border-radius:25px ;" />
                  ...
                  <p align="center"> Already have an account ? <a href="index2.php" class="text-warning" style="font-weight:600; text-decoration:none;">Login</a></p>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                  <img src="signu.jpg" class="img-fluid" alt="Sample image" height="300px" width="500px">
