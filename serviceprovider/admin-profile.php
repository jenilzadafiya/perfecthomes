...
if (strlen($_SESSION['bpmsaid']==0)) {
  ...
  {
    $providerid=$_SESSION['bpmsaid'];
    $aname=$_POST['providername'];
  $mobno=$_POST['contactnumber'];
  
     $query=mysqli_query($con, "update provider set ProviderName ='$aname', MobileNumber='$mobno' where ID='$providerid'");
    if ($query) {
...
<html>
<head>
<title>Perfect Build | Service Provider's Profile</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Provider's Profile</h3>
  ...
  <?php
$providerid=$_SESSION['bpmsaid'];
$ret=mysqli_query($con,"select * from provider where ID='$providerid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>
							 <div class="form-group"> <label for="exampleInputEmail1">Your Name</label> <input type="text" class="form-control" id="providername" name="providername" placeholder="Your Name" value="<?php  echo $row['ProviderName'];?>"> </div> <div class="form-group"> <label for="exampleInputPassword1">User Name</label> <input type="text" id="username" name="username" class="form-control" value="<?php  echo $row['UserName'];?>" readonly="true"> </div>
