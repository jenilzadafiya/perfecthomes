...
<body class="agileits_w3layouts">
	<h2 class="agile_head text-center"><a href="../welcome.php">Navigate to your home page</a></h2>
    <h1 class="agile_head text-center">Share your feedback</h1>
