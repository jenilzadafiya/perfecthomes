    ...
    <div class="row gx-0 d-none d-lg-flex">
      <div class="col-lg-7 px-5 text-start">
        <div class="h-100 d-inline-flex align-items-center border-start border-end px-3">
          ...
          <small><a href = "tel: +91 9104671383">+91 9104671383</a></small>
        </div>
        <div class="h-100 d-inline-flex align-items-center border-end px-3">
          <small class="far fa-envelope-open me-2"></small>
          <small><a href = "mailto: perfectbuild952@gmail.com">perfectbuild952@gmail.com</a></small>
        </div>
        <div class="h-100 d-inline-flex align-items-center border-end px-3">
  ...
  <button type="button" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
    ...
    <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-light m-0">
              <a href="index2.php" class="dropdown-item">User</a>
              <a href="serviceprovider/index.php" class="dropdown-item">Service Provider</a>
              <a href="admin/index.php" class="dropdown-item">Admin</a>
            </div>
          </div>
    <a href="service.php" class="nav-item nav-link">Our Services</a>
    <a href="index2.php" href="./appointment/appointment.php" class="nav-item nav-link">Book Now</a>
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                  ...
                  <a href="register.php" class="btn btn-primary py-3 px-5">Register</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p><i class="fa fa-envelope me-3"></i>perfectbuild942@gmail.com</p>
        </div>
        <div class="col-lg-3 col-md-6">
